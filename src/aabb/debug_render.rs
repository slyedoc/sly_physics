...
impl Plugin for DebugAabbPlugin {
    fn build(&self, app: &mut App) {
        ...
        app.world.resource_mut::<Assets<Shader>>().set_untracked(
            AABBS_SHADER_HANDLE,
            Shader::from_wgsl(include_str!("aabbs_pulling.wgsl")),
        );
...
impl SpecializedMeshPipeline for CustomPipeline {
    ...
    fn specialize(
        ...
        descriptor.vertex.shader = AABBS_SHADER_HANDLE.typed().clone();
        ...
        descriptor.fragment.as_mut().unwrap().shader = AABBS_SHADER_HANDLE.typed().clone();
